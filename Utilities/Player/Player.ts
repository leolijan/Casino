...
/**
 * Constructs a new person object with specified name, password, 
 * and initial balance.
 *
 * @example
 * const person = createPerson('Test User', 'password123', 1000);
 * // person is { name: 'Test User', 
 ...
 * @returns Returns a new person object with the provided 
 *          details and an empty hand.
 */
