...
function showHand(person) {
    ...
    var handRepresentation = person.hand.map(function (card) { return "".concat(card.value, " of ").concat(card.suit); }).join(', ');
    console.log("".concat(person.name, "'s hand: ").concat(handRepresentation));
}
