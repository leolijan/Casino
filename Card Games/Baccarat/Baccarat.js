...
function startGame(player) {
    return __awaiter(this, void 0, void 0, function () {
        var deck, banker, prompt, bet, options, userInput, finalPlayerHand, finalBankerHand, _a, outcome, winnings, playAgainOptions;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    player.hand = [];
                    deck = (0, Deck_1.createBlackjackDeck)();
                    banker = { name: "Banker", password: "", balance: 0, hand: [] };
                    prompt = "You have $" + player.balance + ". How much would you like to bet? ";
