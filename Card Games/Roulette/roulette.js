...
exports.calcDozens = exports.calcColumns = exports.calcLowOrHigh = exports.calcEvenOrOdd = exports.calcRedOrBlack = exports.calcDoubleStreet = exports.calcCorner = exports.calcStreet = exports.calcSplit = exports.calcSingle = exports.calcPayout = exports.calculateWinnings = exports.columnsAndDozensBet = exports.evenBets = exports.numberBet = exports.buildABet = exports.addBetAmount = exports.playerMove = exports.startRoulette = exports.EvenOdd = exports.LowHigh = exports.Color = void 0;
...
var allBets = (0, list_1.empty_list)();
...
exports.startRoulette = startRoulette;
/**
...
function playerMove(person) {
    return __awaiter(this, void 0, void 0, function () {
        var before, stake, bet, prompt, userInput, winningNumber, winnings, delta, str, prompt_1, userInput_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    // could add print_options from login
                ...
                case 3:
                    ...
                    return [4 /*yield*/, playerMove(person)];
                case 4:
                    _a.sent();
                    return [3 /*break*/, 8];
                case 5:
                    ...
                    console.log();
                    winnings = calculateWinnings(allBets, winningNumber);
                    person.balance += winnings;
                    delta = person.balance - before;
                    str = delta > 0 ? "YOU WON " + delta + " DOLLARS" : delta < 0 ? "YOU LOST " + Math.abs(delta) + " DOLLARS" : "YOU BROKE EVEN";
                    console.log(str);
                ...
                case 6:
                    userInput_1 = _a.sent();
                    if (!(userInput_1 === "1")) return [3 /*break*/, 8];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 17:
                    ...
                    first = Number(inp);
                    bet[2][0] = first;
                    return [4 /*yield*/, (0, readUserInput_1.readUserInput)("Choose second street: street " +
...
playerMove((0, Player_1.createPerson)("hej", "jsdiojids", 1000000000));
