...
exports.calcDozens = exports.calcColumns = exports.calcLowOrHigh = exports.calcEvenOrOdd = exports.calcRedOrBlack = exports.calcDoubleStreet = exports.calcCorner = exports.calcStreet = exports.calcSplit = exports.calcSingle = exports.calcPayout = exports.calculateWinnings = exports.columnsAndDozensBet = exports.evenBets = exports.numberBet = exports.buildABet = exports.addBetAmount = exports.playerMove = exports.startGame = exports.EvenOdd = exports.LowHigh = exports.Color = void 0;
...
function computerMove(person, before) {
    ...
    var str = delta > 0 ? "YOU WON " + delta + " DOLLARS" : delta < 0 ? "YOU LOST " + Math.abs(delta) + " DOLLARS" : "YOU BROKE EVEN";
    console.log(str);
